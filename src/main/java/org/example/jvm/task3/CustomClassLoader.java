...
class CustomClassLoader extends ClassLoader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CustomClassLoader loader1 = new CustomClassLoader(".\\exercise\\jvm\\task3");
        CustomClassLoader loader2 = new CustomClassLoader(".\\exercise\\jvm\\task3");

        // Load class SimpleClass using two different loaders
        Class<?> clazz1 = loader1.loadClass("org.example.jvm.task3.SimpleClass");
        Class<?> clazz2 = loader2.loadClass("org.example.jvm.task3.SimpleClass");
